...
int obstacle_number = 0; /* number of obstacles per wall */
...
const char * outputfilename = "capillary2.001-001";
 ...
 * set in the main input file for Ludwig. */
  ...
  /* SURFACE CHARGE */
  double sigma, fwall, fwallplus, fwallminus, sigmaplus, sigmaminus, w;
  zmax = 16;
  xmax=80;
  ymax=18;
  sigma=0.2;
